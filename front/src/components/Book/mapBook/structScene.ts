export const structScene = {
    ...
    'Описание сцены': {
        ...
        example:
            'Название и окружение — Пустынная городская улица, вымощенная блеклыми камнями. Единственный старинный чугунный фонарь светит тускло. Около него — брошенная газета, открытая витрина закрытой лавки.\n' +
    ...
    'Персонажи': {
        ...
        example:
            ...
            'Маша — сестра Саши, около 7 лет, весёлое лицо с широкой улыбкой, держит воздушный шар в руке, стоит на траве, в центре кадра, средний масштаб, повернута лицом к камере.\n' +

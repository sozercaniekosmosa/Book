export const structScene = {
    ...
    'Краткое описание': {
        ...
        desc: 'Краткое описание сцены и действий в ней',
        value: ''
    },
    'Название кратко': {
        options: {excludes: 'toggle', includes: 'value'},
    ...
    'Описание сцены': {
        options: {excludes: 'toggle', includes: 'value'},
        desc:
            'Название сцены и описание — Кратко описать композицию сцены\n' +
        ...
        requirements:
            'Необходимо четко сформулировать и перечислить: Название-описание, ситуацию, ракурс, время действия, настроение, тон сенсорные детали.\n' +
    ...
    'Сущности': {
        ...
        requirements:
            'Необходимо четко сформулировать и описать всех персонажи и предметы сцены по формуле: [Имя/предмет] — [короткое описание], [эмоции жесты], [взаимодействие], [положение, поза в кадре], [отностиельное положение], [масштаб], [куда смотрит/повернут].',
        example:
